...
from bag_classifer import train_classifer
...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global styles
        with open("styleslist.txt", "r") as f:
            x = f.read()
            z = x.rstrip().split(" ")
            for i in z:
                styles.add(i)
...
class PageOne(tk.Frame):
    ...
    def start_training(self):
        ...
        if self.user_name.get() == "None":
            messagebox.showerror("Error", "Style cannot be 'None'")
            return
        elif self.user_name.get() in names:
            messagebox.showerror("Error", "Style already exists!")
            return
        elif len(self.user_name.get()) == 0:
            messagebox.showerror("Error", "Style cannot be empty!")
            return
...
class PageTwo(tk.Frame):
    ...
    def refresh_names(self):
        ...
        for name in names:
            self.dropdown['menu'].add_command(label=name, command=tk._setit(self.menuvar, style))
...
class PageThree(tk.Frame):
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will Capture 300 pic of your Bag.")
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Bag Style Recognition", font='Helvetica 16 bold')
        label.grid(row=0,column=0, sticky="ew")
        button1 = tk.Button(self, text="Bag Style Recognition", command=self.openwebcam, fg="#ffffff", bg="#263942")
